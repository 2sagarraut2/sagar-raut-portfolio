export const projects = [
    ...
    {
      title: "Tongzhi assistant",
      subtitle: "HR AI Assistant",
      description:
        "Built an AI-powered HR Assistant that automates employee queries, leave requests, and document generation, reducing manual HR workload by over 60%.",
      tech: ["React.js", "Context API", "Ant Design"],
      link: "https://github.com/2sagarraut2/Tongzhi-Web",
      metrics: ["25% faster load", "30% better responsiveness", "Better UI/UX"],
    },
    {
      title: "STOCKPILOT",
